...
class VkontakteResourceOwnerTest extends GenericResourceOwnerTest
{
    ...
    {
        $this->assertEquals(
            'http://api.vk.com/oauth/authorize?response_type=code&client_id=clientid&scope=&redirect_uri=http%3A%2F%2Fredirect.to%2F',
