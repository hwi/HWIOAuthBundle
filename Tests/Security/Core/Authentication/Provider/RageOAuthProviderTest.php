...
use HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\RageOAuthProvider;
use HWI\Bundle\OAuthBundle\Security\Core\Authentication\Token\OAuthToken;
use HWI\Bundle\OAuthBundle\Tests\Fixtures\OAuthAwareException;

class RageOAuthProviderTest extends \PHPUnit_Framework_TestCase
{
    public function testSupportsOAuthToken()
    {
        $oauthProvider = new RageOAuthProvider($this->getOAuthAwareUserProviderMock(), $this->getResourceOwnerMapMock(), $this->getUserCheckerMock());
    ...
    public function testAuthenticatesToken()
    {
        ...
        $oauthProvider = new RageOAuthProvider($userProviderMock, $resourceOwnerMapMock, $userCheckerMock);
    ...
    {
        return $this->getMock('\HWI\Bundle\OAuthBundle\Security\Core\User\RageOAuthAwareUserProviderInterface');
    }
