            ...
            ->arrayNode('resource_owners')
                ...
                ->prototype('array')
                    ->children()
                        ...
                        ->scalarNode('type')
                            ->validate()
                                ->ifNotInArray(array('facebook', 'oauth2', 'github', 'google', 'windows_live', 'vkontakte'))
                    ...
                    ->validate()
                        ...
                        ->thenInvalid("All parameters are mandatory for types 'oauth2'. Check if you're missing one of: access_token_url, authorization_url, infos_url or paths or user_response_class.")
                    ->end()
                    ->validate()
                        ->ifTrue(function($c) {
                            // skip if this contains a service
                        ...
                        ->thenInvalid("At least 'username' and 'displayname' paths should be configured for the oauth2 type.")
                    ->end()
                    ->validate()
                        ->ifTrue(function($c) {
